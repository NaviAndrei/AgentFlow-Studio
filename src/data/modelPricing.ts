...
/** Claude models with computer-use tool support, shared by validation and the Inspector. */
export const COMPUTER_USE_MODELS = ['claude-opus-4-8', 'claude-sonnet-4-6'] as const
