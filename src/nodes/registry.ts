...
export const NODE_META: Record<AgentFlowNodeType, NodeMeta> = {
  ...
  a2aAgent: {
    ...
    color: '#0f766e',
    icon: Radio,
    description: 'Call a remote agent via A2A protocol',
  },
  planner: {
    type: 'planner',
    label: 'Planner',
  ...
  multimodalInput: {
    ...
    color: '#be185d',
    icon: Image,
    description: 'Image / audio / document entry point',
  },
  computerUse: {
    type: 'computerUse',
    label: 'Computer Use',
    ...
    color: '#2563eb',
    icon: Monitor,
    description: 'Browser-automation loop (computer-use)',
  },
  subgraph: {
    type: 'subgraph',
    label: 'Subgraph',
...
export const PALETTE: { title: string; types: AgentFlowNodeType[] }[] = [
  ...
  {
    title: 'Memory',
    types: ['memory', 'longTermStore', 'memoryWriter'],
  },
  {
    title: 'Flow Control',
